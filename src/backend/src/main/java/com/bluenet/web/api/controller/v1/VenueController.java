...
public class VenueController {
    ...
    public ResponseMessage<List<VenueDTO>> getVenueList() {
        List<VenueDTO> venues = venueService.getVenueList();
        return ResponseMessage.success(venues);
    }
    ...
    public ResponseMessage<VenueDTO> getVenueById(@PathVariable Long id) {
        VenueDTO venue = venueService.getVenueDetail(id);
        return ResponseMessage.success(venue);
    }
}
