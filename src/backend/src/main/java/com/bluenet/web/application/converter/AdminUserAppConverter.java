...
@Component
public class AdminUserAppConverter {

    public PageDTO<AdminUserListItemResponseDTO> toPageDTO(
            org.springframework.data.domain.Page<AdminUserResult.ListItem> page) {
