...
public class MemberController {
    ...
    public ResponseMessage<PageDTO<MemberBriefDTO>> getMemberList(
            ...
            @Parameter(description = "方向筛选") @RequestParam(required = false) com.bluenet.web.domain.model.enumerate.Direction direction) {
        MemberListQueryDTO query = MemberListQueryDTO.builder()
                .page(page)
                .size(size)
                .direction(direction)
                .build();
        return ResponseMessage.success(memberService.getMemberList(query));
    }
    ...
    public ResponseMessage<MemberDetailDTO> getMemberById(
        ...
        try {
            return ResponseMessage.success(memberService.getMemberById(id));
    ...
    public ResponseMessage<List<DirectionLeaderDTO>> getDirectionLeaders() {
        return ResponseMessage.success(memberService.getDirectionLeaders());
    }
