...
class UserInfoController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "成功，body 为 ResponseMessage，code=200，data 为当前用户信息", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UserInfo.class))) })
    ...
    public UserInfo getMyInfo() {
        ...
        return userInfoResponseConverter.toDTO(userInfoAppService.getMyInfo(userId));
    }
}
