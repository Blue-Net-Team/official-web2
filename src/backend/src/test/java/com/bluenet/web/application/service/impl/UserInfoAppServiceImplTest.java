...
class UserInfoAppServiceImplTest {
    ...
    void getMyInfo_whenNoUserInContext_throwsUnauthorized() {
        ...
        Unauthorized ex = assertThrows(Unauthorized.class, () -> userInfoAppService.getMyInfo());
    ...
    class UpdateAvatarTests {
        ...
        void updateAvatar_success() {
            ...
            userInfoAppService.updateAvatar(new UserInfoCommands.UpdateAvatarCommand(100L));
        ...
        void updateAvatar_fileNotFound_throwsDataNotFound() {
            ...
            DataNotFound ex = assertThrows(
                    DataNotFound.class,
                    () -> userInfoAppService.updateAvatar(new UserInfoCommands.UpdateAvatarCommand(9999L)));
