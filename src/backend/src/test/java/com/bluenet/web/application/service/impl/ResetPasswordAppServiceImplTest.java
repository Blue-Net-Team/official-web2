...
@DisplayName("ResetPasswordAppServiceImpl 单元测试")
@ExtendWith(MockitoExtension.class)
class ResetPasswordAppServiceImplTest {
    ...
    @InjectMocks
    private ResetPasswordAppServiceImpl resetPasswordAppService;
    ...
    class VerifyStudentTests {
        ...
        void verifyStudent_existingStudent_shouldReturnToken() {
            ...
            ResetPasswordResult.VerifyStudent result = resetPasswordAppService.verifyStudent(
                    new ResetPasswordCommands.VerifyStudentCommand(TEST_STUDENT_ID));

            assertEquals(TEST_TOKEN, result.resetToken());
        ...
        void verifyStudent_nonExistingStudent_shouldThrowBadRequest() {
            ...
            BadRequest exception = assertThrows(
                    BadRequest.class,
                    () -> resetPasswordAppService.verifyStudent(
                            new ResetPasswordCommands.VerifyStudentCommand(TEST_STUDENT_ID)));
    ...
    class VerifyEmailTests {
        ...
        void verifyEmail_matchingEmail_shouldReturnToken() {
            ...
            ResetPasswordResult.VerifyEmail result = resetPasswordAppService.verifyEmail(
                    new ResetPasswordCommands.VerifyEmailCommand(TEST_TOKEN, TEST_EMAIL));
        ...
        void verifyEmail_mismatchedEmail_shouldThrowBadRequest() {
            ...
            BadRequest exception = assertThrows(
                    BadRequest.class,
                    () -> resetPasswordAppService.verifyEmail(
                            new ResetPasswordCommands.VerifyEmailCommand(TEST_TOKEN, "wrong@example.com")));
    ...
    class SendCodeTests {
        ...
        void sendCode_normal_shouldSucceed() {
            ...
            assertDoesNotThrow(
                    () -> resetPasswordAppService.sendCode(
                            new ResetPasswordCommands.SendCodeCommand(TEST_TOKEN)));
    ...
    class VerifyCodeTests {
        ...
        void verifyCode_correct_shouldSucceed() {
            ...
            assertDoesNotThrow(
                    () -> resetPasswordAppService.verifyCode(
                            new ResetPasswordCommands.VerifyCodeCommand(TEST_TOKEN, TEST_CODE)));
        ...
        void verifyCode_wrongCode_shouldThrowBadRequest() {
            ...
            BadRequest exception = assertThrows(
                    BadRequest.class,
                    () -> resetPasswordAppService.verifyCode(
                            new ResetPasswordCommands.VerifyCodeCommand(TEST_TOKEN, "000000")));
        ...
        void resetPassword_normal_shouldSucceed() {
            ...
            assertDoesNotThrow(
                    () -> resetPasswordAppService.resetPassword(
                            new ResetPasswordCommands.ResetPasswordCommand(TEST_TOKEN, "newPassword123")));
