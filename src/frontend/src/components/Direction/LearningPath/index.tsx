        ...
        {data.map((step, index) => (
          <Col key={step.step} xs={24} lg={6}>
            <div className="flex items-center gap-4 max-[991px]:flex-col max-[991px]:items-stretch max-[991px]:gap-3">
              <div
                className={`flex-1 bg-[#111111] rounded-xl p-8 px-6 flex flex-col gap-2 border border-[#222222] transition-colors duration-300 hover:border-[var(--theme-primary)] max-lg:p-6 max-lg:px-5 max-[991px]:flex-row max-[991px]:items-center max-[991px]:gap-4 max-[991px]:p-5 max-[991px]:px-4 ${step.videoLink ? 'cursor-pointer' : ''}`}
