...
- [x] 3.1 扩展 `qrcode.service.ts` 添加管理端 API 调用
...
- [x] 3.2 添加相关 TypeScript 类型定义

### 4. 二维码管理页面

- [x] 4.1 创建 `/admin/qrcode/page.tsx` 主页面
- [x] 4.2 实现 Tab 切换组件（咨询群/考核群）
- [x] 4.3 实现咨询群二维码列表展示
- [x] 4.4 实现考核群二维码列表展示
- [x] 4.5 实现考核群筛选器（方向、轮次）
- [x] 4.6 实现上传按钮和交互

### 5. 二维码编辑 Drawer

- [x] 5.1 创建 `QrcodeDrawer.tsx` 组件
- [x] 5.2 实现咨询群编辑表单（图片上传）
- [x] 5.3 实现考核群编辑表单（方向、轮次、共用、图片上传）
- [x] 5.4 实现共用开关逻辑（开启时清空方向）
- [x] 5.5 实现图片预览功能
