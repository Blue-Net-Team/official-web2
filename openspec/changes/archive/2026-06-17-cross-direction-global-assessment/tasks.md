...
- [x] 9.2 创建全局考核（SUPER_ADMIN），验证创建成功且 direction/grade 为 null
- [x] 9.3 DIRECTION_ADMIN 尝试创建全局考核，验证被 403 拒绝
- [x] 9.4 考生查看考核列表，验证全局考核可见
- [x] 9.5 不同方向考生在全局考核中查看题目、提交答案，验证正常
- [x] 9.6 跨方向组队，验证正常
- [x] 9.7 评审全局考核，验证 DIRECTION_ADMIN 可访问
- [x] 9.8 发布全局考核结果，验证邮件发送和文案正确
